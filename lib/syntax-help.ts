...
const signatures: Record<string, [string, string]> = {
  ...
  rgb: ['rgb(red, green, blue)', '2D color field; real channels from 0 to 255'],
  hsl: ['hsl(hue, saturation, lightness)', '2D color field; hue in degrees, saturation and lightness 0–100'],
  oklch: ['oklch(lightness, chroma, hue)', '2D color field; lightness 0–1, chroma typically 0–0.4, hue in degrees'],
